...
void initModels()
{
	myModel = gps::Model3D("objects/skull/skull.obj", "objects/skull/");
	ground = gps::Model3D("objects/final2/final.obj", "objects/final2/");
...
void renderScene()
{
	...
	model = glm::mat4(1.0f);
	//cu tastatura 
	model = glm::translate(model, glm::vec3(0.0f + move2, 1.0f + move1, 0.0f));
	//auto animation
